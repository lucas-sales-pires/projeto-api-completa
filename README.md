...
## Imagem da API funcionado 

<div align="center">
  <img src="API.png" alt="Imagem da API funcionando" width="100%">
</div>

## Links para testar a API
    GET: https://projeto-api-completa.onrender.com/usuarios
    POST: https://projeto-api-completa.onrender.com/usuarios
    PATCH: https://projeto-api-completa.onrender.com/usuarios/:id
    DELETE: https://projeto-api-completa.onrender.com/usuarios/:id
